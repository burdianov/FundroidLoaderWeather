...
public class WeatherListActivity extends AppCompatActivity
    ...
    private class WeatherCallbacks implements LoaderManager
            .LoaderCallbacks<City> {
    ...
    private void loadWeather(boolean restart, City city, String cityName,
                             Integer id) {
        mLoadingView.showLoadingIndicator();
        LoaderManager.LoaderCallbacks callbacks = new WeatherCallbacks(city,
                cityName);
        if (restart) {
    ...
    private void showError() {
        ...
        Snackbar snackbar = Snackbar.make(mRecyclerView, "Error loading " +
                "weather", Snackbar.LENGTH_LONG)
    ...
    private void showWeather(@Nullable City city) {
        if (city == null || city.getMain() == null || city.getWeather() ==
                null || city.getWind() == null) {
            showError();
            return;
        }
